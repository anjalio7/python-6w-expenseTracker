...
# tables in frame 
        ...
        self.tr = ttk.Treeview(self.main_frame2, columns=('A', 'B', 'C', 'E', 'F'), selectmode="extended")
        ...
        self.tr.heading('#2', text="Expense Allowed")
        ...
        # print(self.data[0][0])
        res = database.allBudget((self.data[0], ))
        if res:
                for i in res:
                        self.tr.insert('', 0, text=i[0], values=(i[2], i[3], 'Edit'))
        else:
